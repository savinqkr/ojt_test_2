...
class AndBasicInfo extends StatelessWidget {
  const AndBasicInfo({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController maximumWaitTime = TextEditingController();

    void onClick() {
      print('taskname : $taskname.text');
      print('taskname : $maximumWaitTime.text');
    }
