...
class AgentSelectFile extends StatefulWidget {
  ...
  @override
  State<AgentSelectFile> createState() => _AgentSelectFileState();
}

class _AgentSelectFileState extends State<AgentSelectFile> {
  // selectedRows
  int selectedRow = -1;
  // onRowTap
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Table(
              ...
              children: <TableRow>[
                ...
                if (widget.data.isEmpty)
                  TableRow(
                      children:
                          widget.columnTitle.map((e) => Container()).toList()),
          ...
          if (AgentGroupData.selectedAgentGroupDataList.isEmpty)
            const Center(
                child: Padding(
