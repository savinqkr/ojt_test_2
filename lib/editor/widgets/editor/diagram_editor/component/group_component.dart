...
import 'package:ojt_test_2/editor/widgets/editor/diagram_editor/component/base_group_body.dart';

class GroupComponentBody extends StatelessWidget {
  final ComponentData componentData;

  const GroupComponentBody({super.key, required this.componentData});

  @override
  Widget build(BuildContext context) {
    return BaseGroupBody(
